...
class CashFlowService:
    ...
    def get_projected_balance(db: Session, days: int) -> ProjectedBalanceResult:
        ...
        try:
            ...
            projected_income = round(avg_daily_income * days)
            ...
            for sub in subscriptions:
                if sub.next_billing_date:
                    ...
                    if next_billing >= now and next_billing <= future_date:
                        subscription_cost += sub.amount_cents or 0
            ...
            iou_cost = sum(iou.amount - (iou.amount_paid or 0) for iou in ious)

            # 5. Seasonal adjustment
            seasonal_adjustment = CashFlowService.calculate_seasonal_adjustment(db, now, future_date)

            # Calculate projected balance
            projected_expenses = subscription_cost + iou_cost
            projected_balance = current_balance + projected_income - projected_expenses + seasonal_adjustment
            ...
            return ProjectedBalanceResult(
                ...
                breakdown={
                    "subscriptions": subscription_cost,
                    "ious": iou_cost,
