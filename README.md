...
[![Análisis de seguridad](https://github.com/Alanjavier22/Tabula-Rasa/actions/workflows/codeql.yml/badge.svg?branch=main)](https://github.com/Alanjavier22/Tabula-Rasa/actions/workflows/codeql.yml)
...
*   **Conexión a Internet**: Opcional para el núcleo financiero local; necesaria para usar Gemini o respaldos externos en Google Drive.
