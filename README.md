...
1.  **Auto-Provisioning y Auto-Update por Winget**: Apenas arranca, el script escanea el PATH del sistema buscando las ejecuciones de **Python 3.12+** y **Node.js**. Si no los encuentra, o si detecta una versión de Python antigua (inferior a 3.12), lanza una instalación/actualización silenciosa nativa utilizando `Winget`. El usuario no necesita buscar webs de descargas, ni configurar variables de entorno manualmente.
